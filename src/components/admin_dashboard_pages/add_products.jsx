    ...
    const update = (field, value) => {
        if (field === "store_type") {
            setForm(prev => ({
                ...prev,
                store_type: value,
                category: ""   // reset category when store type changes
            }));
        } else {
            setForm(prev => ({ ...prev, [field]: value }));
        }
            ...
            <div className="bg-white rounded-xl p-6 border border-brand-gold-light/10 shadow-sm">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <input type="text" placeholder="Hindi Name"
                            className="input-field"
                    ...
                    {/* Pricing */}
                    <div>
                        <h3 className="font-semibold text-brand-brown-dark mb-3">
                            Pricing (₹)
                        </h3>
                        <div className="grid md:grid-cols-4 gap-4">
                            <input type="number" placeholder="100g"
                                className="input-field"
                                value={form.price_100g}
                                onChange={e => update("price_100g", e.target.value)} />

                            <input type="number" placeholder="250g"
                                className="input-field"
                                value={form.price_250g}
                                onChange={e => update("price_250g", e.target.value)} />

                            <input type="number" placeholder="500g"
                                className="input-field"
